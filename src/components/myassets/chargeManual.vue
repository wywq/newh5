...
export default {
  ...
  methods: {
    ...
    submit () {
      if (this.unkdh.rechargeNum && this.unkdh.rechargeDealId && this.der) {
        ...
        formData.append('files', this.unkdh.files)
        this.$post('/api/recharge/manualAdd', formData, {
          headers: {
            'Content-Type': false
          }
        })
