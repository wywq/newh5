<template>
  <div class="recommended">
    <div class="header">
      ...
      <div class="text_con">推荐奖励</div>
      <div class="icon_right">
      </div>
    </div>
    <div class="content">
      <div v-if="chuji.length > 0">
        <div class="new_list" v-for="(item,index) in chuji" :key="index" @click="sjhdi(item.weekNo)">
...
export default {
  ...
  methods: {
    init () {
      this.$post('/api/cwfProfit/list', {type: 2, userId: this.ID, page: this.page})
        .then(res => {
